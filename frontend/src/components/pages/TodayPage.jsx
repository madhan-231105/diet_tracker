...
import { DropIcon } from '../shared/Icons';
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        {byType.map(({ type, meals:typeMeals, cals }) => {
          ...
          return (
            <div key={type} className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              {typeMeals.length === 0 ? (
                ...
                <div className="divide-y divide-slate-100">
                  ...
                  {typeMeals.map(m => (
                    <div key={m._id} className="px-5 py-3 flex justify-between items-center">
