...
const MEAL_TYPE_CONFIG = {
  breakfast: { emoji: '🍳', bg: 'bg-slate-100', text: 'text-slate-600' },
  lunch:     { emoji: '🍱', bg: 'bg-slate-100', text: 'text-slate-600' },
  dinner:    { emoji: '🍽️', bg: 'bg-slate-100', text: 'text-slate-600' },
  snack:     { emoji: '🍎', bg: 'bg-slate-100', text: 'text-slate-600' },
};
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div className={`w-14 h-14 ${cfg.bg} rounded-2xl flex items-center justify-center text-2xl shadow-sm`}>
                        {cfg.emoji}
                      </div>
